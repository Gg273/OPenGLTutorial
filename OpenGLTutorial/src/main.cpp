...
int main()
{
    ...
    Shader lightCubeShader("Shaders/lightingShader.vs", "Shaders/lampShader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 光源属性
        lightingShader.setVec3("light.direction", -0.2f, -1.0f, -0.3f); // 平行光向量
